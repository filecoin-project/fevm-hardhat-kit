...
function App(props) {
  ...
  // 🏗 fevm-starter-kit is full of handy hooks like this one to get your balance:
  ...
  */
  ...
  useEffect(() => {
    if (
      ...
      console.log("_____________________________________ 🏗 fevm-starter-kit _____________________________________");
      ...
      <div style={{ position: "fixed", textAlign: "left", left: 0, bottom: 20, padding: 10 }}>
        <Row align="middle" gutter={[4, 4]}>
          ...
          <Col span={8} style={{ textAlign: "center", opacity: 1 }}>
            <Button
              onClick={() => {
                window.open("https://github.com/filecoin-project/community");
              }}
              size="large"
              shape="round"
            >
